...
class MailingAdmin(admin.ModelAdmin):
    list_display = ['id', 'user', 'created_at', 'name', 'start_time', 'finish_time', 'frequency', 'status', 'message', 'clients_list']
    fields = ['name', 'start_time', 'finish_time', 'frequency', 'message', 'clients', 'user']
